...
<head>
    ...
    <link rel="stylesheet" href="${root}resources/rcss/open-iconic-bootstrap.min.css" />
    <link rel="stylesheet" href="${root}resources/rcss/animate.css" />

    <link rel="stylesheet" href="${root}resources/css/owl.carousel.min.css" />
    <link rel="stylesheet" href="${root}resources/css/owltheme.default.min.css" />
            ...
            <div class="col-lg-12 d-block">
                <div class="row d-flex">
                    <div class="col-md pr-4 d-flex topper align-items-center">
                        ...
                        <span class="text">010-9551-8103</span>
                    </div>
                    <div class="col-md pr-4 d-flex topper align-items-center">
                        <div
                                class="icon mr-2 d-flex justify-content-center align-items-center"
                    ...
                    >
                <span class="text"
                >본 웹사이트는 포트폴리오로써 실제 결제 기능은 지원하지
                  않습니다.</span
                >
                    </div>
                </div>
            ...
            <div class="container-fluid p-0">
                ...
                >
                    <img
                            ...
                            src="${root}/resources/images/bg_1.png"
                            alt=""
                    />
                    <div
...
<section class="ftco-section ftco-deal bg-primary">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <img src="${root}images/prod-1.png" class="img-fluid" alt="" />
            </div>
            <div class="col-md-6">
    ...
    <div class="container-fluid px-0">
        <div class="row no-gutters">
            <div class="col-md-4 col-lg-2 ftco-animate">
                <a
                        href="${root}images/gallery-1.jpg"
            ...
            <div class="col-md-4 col-lg-2 ftco-animate">
                <a
                        href="${root}images/gallery-2.jpg"
                        class="gallery image-popup img d-flex align-items-center"
            ...
            <div class="col-md-4 col-lg-2 ftco-animate">
                <a
                        href="${root}images/gallery-3.jpg"
                        class="gallery image-popup img d-flex align-items-center"
            ...
            <div class="col-md-4 col-lg-2 ftco-animate">
                <a
                        href="${root}images/gallery-4.jpg"
                        class="gallery image-popup img d-flex align-items-center"
            ...
            <div class="col-md-4 col-lg-2 ftco-animate">
                <a
                        href="${root}images/gallery-5.jpg"
                        class="gallery image-popup img d-flex align-items-center"
            ...
            <div class="col-md-4 col-lg-2 ftco-animate">
                <a
                        href="${root}images/gallery-6.jpg"
                        class="gallery image-popup img d-flex align-items-center"
